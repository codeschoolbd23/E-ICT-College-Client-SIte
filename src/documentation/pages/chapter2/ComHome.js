...
const ComHome = () => {
  const src=["https://i.ibb.co/DHRcHRND/network-Layout.jpg",
"https://i.ibb.co/3mV61Sjk/network-Layout2.jpg",
"https://i.ibb.co/xqbXsNKW/network-Layout3.jpg"]
 const h1Cls =
 ...
 return (
   <div className="lg:flex flex-wrap w-full justify-center">
     <div className="lg:p-1 flex w-full lg:h-80">
       {src.map((srclink) => (
         <>
           <img
             src={srclink}
       ...
       <img
         ...
         alt="front-Page"
         border="0"
         className="w-full lg:w-1/2 flex lg:hidden"
       />
     </div>
     <div className="w-full lg:p-1">
       <div className="p-5 lg:text-lg text-shadow-lg/10">
         ...
         <p className="lg:px-5">
           তথ্য (Information) মানে হলো নির্দিষ্ট অর্থবোধক ও ব্যবহারযোগ্য ডেটা যা
           বিশ্লেষণ ও ব্যাখ্যার মাধ্যমে পাওয়া যায়। যোগাযোগ (Communication) মানে
           হলো তথ্য আদান-প্রদানের প্রক্রিয়া — একজন ব্যক্তি বা উৎস থেকে অন্য
           ব্যক্তি বা গন্তব্যে।
         </p>
         <hr />
