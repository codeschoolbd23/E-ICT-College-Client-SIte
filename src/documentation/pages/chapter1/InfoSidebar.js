...
const InfoSidebar = ({ information }) => {
  console.log(information);
  return (
    <div className="drawer lg:drawer-open scrollHead w-full">
      ...
      <div className="drawer-content flex flex-col items-center justify-center">
        ...
        >
          সূচিপত্রঃ তথ্য ও যোগাযোগপ্রযুক্তি: বাংলাদেশ প্রেক্ষিত
        </label>
      </div>
